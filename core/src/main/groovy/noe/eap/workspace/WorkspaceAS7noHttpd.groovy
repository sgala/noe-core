...
class WorkspaceAS7noHttpd extends WorkspaceAbstract {
  ...
  void initWorkspaceAS7noHttpd() {
    log.info('WorkspaceAS7noHttpd.initWorkspaceAS7noHttpd(): BEGIN')
    // TODO: Validate paths
    ...
    log.info('WorkspaceAS7noHttpd.initWorkspaceAS7noHttpd(): END')
  }
   ...
   */
  void installAS7() {
    log.info('WorkspaceAS7noHttpd.installAS7(): EAP BEGIN')
    def eap = new Eap6Utils(basedir, ant, platform, eapVersion, "")
    eap.getIt()
    log.info('WorkspaceAS7noHttpd.installAS7(): EAP END')
  }
